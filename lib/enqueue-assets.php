...
function _themename_assets()
{
  ...
  wp_enqueue_script('_themename', get_template_directory_uri() . '/dist/assets/js/bundle.js', array('jquery'), '1.0.0', true);
}
...
function _themename_admin_assets()
{
  ...
  wp_enqueue_script('_themename-admin-scripts', get_template_directory_uri() . '/dist/assets/js/admin.js', array(), '1.0.0', 'all');
}
