...
function sbu_theme_assets()
{
  ...
  wp_enqueue_script('sbu_theme', get_template_directory_uri() . '/dist/assets/js/bundle.js', array('jquery'), '1.0.0', true);
}
...
function sbu_theme_admin_assets()
{
  ...
  wp_enqueue_script('sbu_theme-admin-scripts', get_template_directory_uri() . '/dist/assets/js/admin.js', array(), '1.0.0', 'all');
}
